...
\begin{figure}
	...
	\subfigure[$\alpha=0.01$]{
		\includegraphics[width=0.3\linewidth]{simulations/results/osc-regions-prediction-alpha=0-01.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.05$]{
		\includegraphics[width=0.3\linewidth]{simulations/results/osc-regions-prediction-alpha=0-05.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.1$]{
		\includegraphics[width=0.3\linewidth]{simulations/results/osc-regions-prediction-alpha=0-1.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.3$]{
		\includegraphics[width=0.3\linewidth]{simulations/results/osc-regions-prediction-alpha=0-3.png}
		\label{fig:theo}
		}		
...
\begin{figure}
	\centering
	\subfigure[$\alpha=0.01$]{
		\includegraphics[width=0.25\linewidth]{simulations/mean-oscillations-alpha=0-01.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.05$]{
		\includegraphics[width=0.25\linewidth]{simulations/mean-oscillations-alpha=0-05.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.1$]{
		\includegraphics[width=0.25\linewidth]{simulations/mean-oscillations-alpha=0-1.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.2$]{
		\includegraphics[width=0.25\linewidth]{simulations/mean-oscillations-alpha=0-2.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.3$]{
		\includegraphics[width=0.25\linewidth]{simulations/mean-oscillations-alpha=0-3.png}
		\label{fig:theo}
		}		
...
\begin{figure}
	\centering
	\subfigure[$\alpha=0.01$]{
		\includegraphics[width=0.25\linewidth]{simulations/osc-region-alpha=0-01.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.05$]{
		\includegraphics[width=0.25\linewidth]{simulations/osc-region-alpha=0-05.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.1$]{
		\includegraphics[width=0.25\linewidth]{simulations/osc-region-alpha=0-1.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.2$]{
		\includegraphics[width=0.25\linewidth]{simulations/osc-region-alpha=0-2.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.3$]{
		\includegraphics[width=0.25\linewidth]{simulations/osc-region-alpha=0-3.png}
		\label{fig:theo}
		}		
...
\begin{figure}
	\centering
	\subfigure[$\alpha=0.01$]{
		\includegraphics[width=0.25\linewidth]{simulations/normalized-profit-alpha=0-01.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.05$]{
		\includegraphics[width=0.25\linewidth]{simulations/normalized-profit-alpha=0-05.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.1$]{
		\includegraphics[width=0.25\linewidth]{simulations/normalized-profit-alpha=0-1.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.2$]{
		\includegraphics[width=0.25\linewidth]{simulations/normalized-profit-alpha=0-2.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.3$]{
		\includegraphics[width=0.25\linewidth]{simulations/normalized-profit-alpha=0-3.png}
		\label{fig:theo}
		}		
...
\begin{figure}
	\centering
	\subfigure[$\alpha=0.01$]{
		\includegraphics[width=0.25\linewidth]{simulations/time-per-block-ch1-alpha=0-1.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.05$]{
		\includegraphics[width=0.25\linewidth]{simulations/time-per-block-ch1-alpha=0-2.png}
		\label{fig:theo}
		}
	\qquad
	\subfigure[$\alpha=0.1$]{
		\includegraphics[width=0.25\linewidth]{simulations/time-per-block-ch1-alpha=0-3.png}
		\label{fig:theo}
		}	
